<?php
    ...
    function getUserInfo($userID, $users){
        ...
        foreach($users as $user){
            if($user["id"] == $userID){
                $loggedInUser = $user;
                $loggedInUserLimitedAcces = ["id" => $user["id"], "username" => $user["username"], "time" => $user["time"],"profilePic" => $user["profilePic"], "unlockedCharacters" => $user["unlockedCharacters"], "suspectCharacters" => $user["suspectCharacters"], "notSuspectCharacters" => $user["notSuspectCharacters"]];
            }
        }
